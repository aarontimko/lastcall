...
- [ ] **[sponsor]** CI green on both OSes after push, and `just probe-tui` seen once on the sponsor's machine (edit a fixture file from a second shell, watch the counts change, `q`, shell sane).
